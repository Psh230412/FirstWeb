  ...
  -->
    ...
    <main>
      <article>
        ...
        - #HERO
      -->
<form id="movieSelectionForm" action="http://localhost:8080/ScreenSceneP/flow" method="POST">
       <input type="hidden" id="selectedMovies" name="movieNumbers" value="">
  ...
  -->
    ...
    - custom js link
  -->
    <script src="./main/script2.js"></script>
